...
btnhakkinda = QtBind.createButton(gui,'btnhakkinda_clicked',"   HAKKINDA   ",650,285)
	...
	if t:
		...
		for key, npc in npcs.items():
			if npc['name'] == source or npc['servername'] == source:
				log("Plugin: TELEPORT SEÇİLİYOR. ["+source+"]")
				...
				Timer(2.0, log, ("Plugin: IŞINLANILIYOR : ["+destination+"]")).start()
				return
